...
<head>
  ...
  <meta name="description:" content="Omifood is a premium food delivery service with the
    mission to bring affordable and healthy meals to as many people as possible">
...
<body>
    ...
    <div class="row">
      <div class="col span-1-of-3">
        <blockquote>
          ...
          <cite><img src="resources/images/customer-1.jpg" alt="Alberto Duncan photo">Alberto Duncan</cite>
        </blockquote>
      </div>
      ...
      <div class="col span-1-of-3">
        <blockquote>
          ...
          <cite><img src="resources/images/customer-2.jpg" alt="Joana Silva photo">Joana Silva</cite>
        </blockquote>
      </div>
      ...
      <div class="col span-1-of-3">
        <blockquote>
          ...
          I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
          <cite><img src="resources/images/customer-3.jpg" alt="Milton Chapman photo">Milton Chapman</cite>
        </blockquote>
      </div>
    </div>
  </section>
  ...
  <section class="section-form" id="form">
    ...
    <div class="row">
      <form class="contact-form" action="mailer-new.php" method="post">
        ...
        <div class="row">
          ...
          <div class="col span-2-of-3">
            <input type="checkbox" name="news" id="news" value="" checked> Yes, please
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col span-2-of-3">
            <textarea name="message" rows="8" cols="50" placeholder="Your Message"></textarea>
          </div>
        </div>
  ...
  <script src="https://cdn.jsdelivr.net/npm/respond.js@1.4.2/.npmignore"></script>
